...
どうやら超音波式加湿器がよくないらしい。タッチパネルやペンタブのデジタイザにダメージを与えるとのこと。Surface Studio に限らず、液タブが壊れるという報告を読んだことがある。
...
## 手順
1. Intel Rapid Storage Technology のバージョンが 14.5.0.1081 なドライバを入手する。新しいドライバではできない。（[DELLのサイト](https://www.dell.com/support/home/ja-jp/drivers/driversdetails?driverid=7x1k1)にあるっぽい・・・）
...
ただし、WD BLACK SN850X (2TB) を装着して使った感じでは、いちおお*ﾋｰﾖﾁﾝｸ*なしで、読み：875MB/s(7Gbps) 書き：2060MB/s(16.48Gbps) 出ているので、付けなくても問題ないだろう。
